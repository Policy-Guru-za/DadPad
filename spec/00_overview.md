...
| `16_single-surface-editor` | Collapse the writing area into one visible editor card | In Progress | Codex | `15_internet-availability-gate` | Remove the double-framed writing surface so the textarea itself becomes the only visible card while preserving all behavior |
