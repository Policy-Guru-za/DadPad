...
| `15_internet-availability-gate` | Gate DadPad behind internet reachability and recover automatically when online returns | In Progress | Codex | `14_portrait-only-orientation-lock` | Add startup/wake connectivity probing, a full-app offline overlay, and automatic recovery without remounting the live UI |
