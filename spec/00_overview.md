...
| `18_voice-preserving-polish` | Recalibrate DadPad `Polish` to sound like the same person, just cleaner | In Progress | Codex | `17_action-dock-remap` | Shift `Polish` away from neutral-professional smoothing and toward voice-preserving cleanup with strong paragraphing and restrained bullet usage |
