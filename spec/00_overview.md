...
| `17_action-dock-remap` | Move Settings to the top row and place Copy beneath Clear | In Progress | Codex | `16_single-surface-editor` | Keep existing behavior/styling, but remap the visible action order to `Polish / Clear / Settings` then `Share / Copy / spacer` |
